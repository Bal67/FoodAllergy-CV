...
train_annotations = '/content/drive/MyDrive/FoodAllergyData/train_annotations.csv'
test_annotations = '/content/drive/MyDrive/FoodAllergyData/test_annotations.csv'
target_size = (224, 224)
